...
## 2. Secrets & Zero-Credential Policy

- **No Committed Secrets**: `secret-template.yaml` contains only schema placeholders (`CHANGE_ME_*`).
...
## 3. Kubernetes Network Micro-Segmentation
