...
====================================
Phase 21 Cloud & Container Security Models.
Covers Cloud Asset Inventory, CSPM Misconfiguration Findings, Container Scans,
SBOM Inventories, Kubernetes Workload Audits, Cloud IAM Risks, and Attack Paths.
"""
...
class CloudAsset(Base):
    ...
    asset_type: Mapped[str] = mapped_column(String(50), nullable=False, index=True) # VM, CONTAINER, K8S_POD, K8S_DEPLOYMENT, DATABASE, STORAGE_BUCKET, LOAD_BALANCER, IAM_ROLE, IAM_USER
