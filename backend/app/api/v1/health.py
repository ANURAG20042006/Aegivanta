...
async def prometheus_metrics(db: AsyncSession = Depends(get_db)):
    ...
    lines = [
        ...
        "",
        "# HELP sentinel_redis_connected Distributed Redis streaming broker connection status",
        ...
        "",
        "# HELP sentinel_stream_published_total Total telemetry events published to durable stream",
        "# TYPE sentinel_stream_published_total counter",
        f"sentinel_stream_published_total {dist_m['published_total']}",
        "",
        "# HELP sentinel_stream_consumed_total Total streaming telemetry events consumed by workers",
        "# TYPE sentinel_stream_consumed_total counter",
        f"sentinel_stream_consumed_total {dist_m['consumed_total']}",
        "",
        "# HELP sentinel_stream_acked_total Total stream messages successfully processed and acknowledged",
        "# TYPE sentinel_stream_acked_total counter",
        f"sentinel_stream_acked_total {dist_m['acked_total']}",
        "",
        "# HELP sentinel_stream_retried_total Total stream message retry attempts",
        "# TYPE sentinel_stream_retried_total counter",
        ...
        "",
        "# HELP sentinel_pubsub_published_total Total messages published to Redis Pub/Sub backplane",
        "# TYPE sentinel_pubsub_published_total counter",
        f"sentinel_pubsub_published_total {dist_m['pubsub_published_total']}",
        "",
        "# HELP sentinel_websocket_broadcast_total Total WebSocket events broadcasted across distributed instances",
        "# TYPE sentinel_websocket_broadcast_total counter",
