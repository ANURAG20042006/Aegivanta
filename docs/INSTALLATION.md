...
- **Frontend Dashboard**: Open `http://localhost:5173` or `http://localhost:80`. Login using `admin` / `AdminSecure2026!` (Anurag Rai), or `anshika` / `AnshikaSecure2026!` (Anshika Mishra).
